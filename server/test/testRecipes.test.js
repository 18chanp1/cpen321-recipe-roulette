...
describe("Save chosen recipe and return its details", () => {
    ...
    test("Recipe exists in db", async () => {
        ...
        expect(res.body.recipeName).toEqual(expectedResponse.recipeName);
        expect(res.body.recipeSummary).toEqual(expectedResponse.recipeSummary);
        expect(res.body.instructions).toEqual(expectedResponse.instructions);
        expect(res.body.numTimes).toEqual(expectedResponse.numTimes);
    });
